...
def execute_wasm_contract(tx: Dict) -> str:
    ...
    dest_addr = c_void_p(base_ptr.value + sender_ptr)  # Correct address calculation
    ...
    dest_addr = c_void_p(base_ptr.value + asset_type_ptr)
    ...
    dest_addr = c_void_p(base_ptr.value + token_ptr)
